...
export default function Bloomberg() {
	...
	return (
		<div className="bg-white min-h-[calc(100vh - 7rem)] flex flex-col w-full">
					...
					<div className="flex flex-col md:flex-row items-center justify-center gap-8">
						...
						<div className="bg-white/90 p-4 text-black text-center max-w-md">
							...
							<div className="flex gap-10 justify-center items-center">
								...
								/>
								<button className="bg-gray-500 text-white px-6 py-2 text-2xl font-light hover:bg-[#0E5791]">
									<a
			...
			<div className="relative z-10 bg-white flex gap-32 justify-center py-8 h-full px-72">
				{/* Bloomberg Office Hours & Contact Information */}
				<div className="w-fit">
					{/* Bloomberg Office Hours */}
					<div className="flex justify-center">
						<div className="w-fit">
							<h2 className="text-4xl text-gray-500 font-serif text-center pb-2">
								Bloomberg Office Hours
							</h2>
							<div className="flex flex-col items-center justify-center mb-4">
					...
					<div className="mt-12">
						<div className="flex justify-center">
							<div className="w-full">
								<h2 className="text-4xl text-gray-500 font-serif text-center pb-2 px-8">
									Contact Information
								</h2>
								<div className="flex flex-col items-center justify-center mb-4">
									<div className="w-full bg-gray-500 h-0.5 mb-1" />
						...
						<div className="mt-2 text-lg text-left gap-4 flex flex-col px-8">
							<div>
				...
				<div className="md:w-1/2 mt-12 md:mt-0 flex flex-col items-center">
					<div className="flex justify-center">
						<div className="w-fit">
							<h2 className="text-4xl text-gray-500 font-serif text-center pb-2 px-12">
								Resources
							</h2>
							<div className="flex flex-col items-center justify-center mb-4">
								<div className="w-full bg-gray-500 h-0.5 mb-1" />
